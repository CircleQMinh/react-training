...
import { ClearCookie } from "../../utils/cookieHelper.ts";
...
const AppHeader = () => {
  ...
  function toggleDropdown() {
    const dropdown = document.getElementById("dropdown-menu-user");
    if (dropdown) {
            ...
            <div className="flex items-center">
              ...
              <div className="flex items-center ml-3">
                <div>
                  ...
                  >
                    ...
                    <img
                      ...
                      src={isAuthenticated.image ?? "https://flowbite.com/docs/images/people/profile-picture-5.jpg"}
                      alt="user photo"
                    />
                  </button>
                </div>
                ...
                <div className="relative inline-block text-left" onClick={toggleDropdown}>
                  ...
                  <div
                    className=" hide absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black/5 focus:outline-none"
                    role="menu"
